      ...
      <div className='w-full max-w-[800px] mt-12 flex flex-col gap-4 md:min-h-[calc(100vh-64px-7rem)]'>
        ...
        <div className='flex flex-row gap-4 items-center'>
          ...
          <div>
            ...
            <div><Link className='text-2xl font-semibold' href='https://www.facebook.com/theSpiceofLifeSolZycia'>The spice of life</Link></div>
          </div>
        </div>
        <div className='flex flex-row gap-4 items-center'>
          <Card radius='lg' className='min-w-[72px] aspect-square'>
          ...
          <div>
            ...
            <div className='text-2xl font-semibold'>ul. Marynarki Polskiej 3, 80-557 Gdańsk</div>
          </div>
        </div>
        <Divider />
        <div>
