          ...
          <div className='flex flex-row gap-4 w-full justify-center items-center'>
            ...
            <div className='h-full flex flex-col items-center justify-center'>
              ...
              <div className='text-justify'>
                ...
                to nadrabiając wiedzą i doświadczeniem. Najbardziej komfortowym "wyjściem do lasu" była corocznie
                zdobywana sprawność "Trzy pióra" - można powiedzieć że to wyjście do lasu miało "gdzieś tam" wsparcie
                logistyczne" chyba że się zgubiliśmy w lesie. Nasze umiejętności nabyte podczas kilku dekad pozwalają
