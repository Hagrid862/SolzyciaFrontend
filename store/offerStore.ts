...
export const useOfferStore = create<IState>((set, get) => ({
  ...
  fetchProducts: async (reviews?: boolean, orderBy?: 'created_at' | 'price' | 'name' | 'rating' | 'popularity', order?: 'desc' | 'asc', page?: number, limit?: number): Promise<{isSuccess: boolean}> => {
  ...
  fetchProductsByCategory: async (reviews?: boolean, orderBy?: 'created_at' | 'price' | 'name' | 'rating' | 'popularity', order?: 'desc' | 'asc', page?: number, limit?: number) => {
    set({products: ['loading']});
  ...
  fetchEvents: async (reviews?: boolean, orderBy?: 'created_at' | 'price' | 'name' | 'rating' | 'popularity', order?: 'desc' | 'asc', page?: number, limit?: number) => {
    set({events: ['loading']});
  ...
  fetchEventsByCategory: async (reviews?: boolean, orderBy?: 'created_at' | 'price' | 'name' | 'rating' | 'popularity', order?: 'desc' | 'asc', page?: number, limit?: number) => {
    set({events: ['loading']});
...
export interface IState {
  ...
  fetchProducts: (reviews?: boolean, orderBy?: 'created_at' | 'price' | 'name' | 'rating' | 'popularity', order?: 'desc' | 'asc', page?: number, limit?: number) => Promise<{isSuccess: boolean}>;
  fetchProductsByCategory: (reviews?: boolean, orderBy?: 'created_at' | 'price' | 'name' | 'rating' | 'popularity', order?: 'desc' | 'asc', page?: number, limit?: number) => Promise<{ isSuccess: boolean }>;
