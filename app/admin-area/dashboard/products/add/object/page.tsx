    ...
    <>
      <div className='flex flex-col gap-4'>
        ...
        <Input
          ...
          description='wpisz tu krótką i czytelną nazwę przemiotu, np. "iPhone 14 pro"'
          isRequired
          value={name}
        ...
        <Textarea
          ...
          isInvalid={err === 3 || err === 4}
          errorMessage={
            err === 3 ? 'Opis przedmiotu jest wymagany!' : err == 4 ? 'Opis musi mieć conajmniej 50 znaków' : ''
          }
        />
            ...
            <ModalBody>
              <div className='flex flex-col items-center justify-center gap-4'>
                ...
                <Button
                  ...
                  onClick={() => {
                    setShowModal(false)
                    router.push('/admin-area/dashboard/products')
                  }}
                >
                  Zamknij
                </Button>
