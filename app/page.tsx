    ...
    <main>
      <div className='w-screen flex items-center justify-center relative'>
        ...
        <Image
          src={converVertical}
          alt='cover'
          className='mt-4 rounded-xl md:h-auto h-screen w-[300%] block md:hidden'
          priority
        />
        ...
        <Card className='w-full ml-4 md:ml-8 mr-4 max-w-[600px]'>
          ...
          <CardBody>
            <p className='text-justify'>
              Jesteśmy pasjonatami mocnych wrażeń i dobrej zabawy. Naszą specjalizacją są Eventy Firmowe oraz Imprezy
              Integracyjne o tematyce ekstremalnej, survivalowej i outdoorowej. Pomimo, że jest to nasza ulubiona
              tematyka, jesteśmy również świetni w organizacji bankietów, szkoleń jak i wyjazdów integracyjnych.
              WSZYSTKIE ATRAKCJE W JEDNEJ LOKALIZACJI! Zapoznaj się z naszą ofertą i skontaktuj się z nami już dziś!
            </p>
          </CardBody>
        </Card>
      </div>
