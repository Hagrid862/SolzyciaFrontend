  ...
  return (
    <div className='w-full flex flex-col items-center justify-center relative'>
      <div className='h-[calc(100vh-64px)] relative w-full mb-12'>
        <Image src={banner} alt='offroad-jeep' className='w-full h-full opacity-75' layout='fill' objectFit='cover' />
        <div className='absolute top-1/3 left-12'>
          <div className='md:text-6xl text-4xl lg:text-8xl font-bold '>Off-Road</div>
          <div className='md:text-xl text-lg lg:text-3xl font-semibold'>Przygoda zaczyna się tutaj.</div>
        </div>
      </div>
      <div className='w-full md:max-w-[1200px] px-2 md:px-0 max-w-screen'>
        ...
        <Image src={natureOffroad} alt='mountains-offroad' className='order-first md:order-last w-full md:w-1/3 rounded-3xl' />
        <div className='flex flex-col h-full'>
          <div className='text-4xl font-bold text-center md:text-left mb-4'>Eksploruj Naturę</div>
        ...
        <div className='w-full flex flex-col md:flex-row gap-12 my-8 items-center'>
          <Image src={mudOffroad} alt='mountains-offroad' className='md:w-1/3 rounded-3xl' />
          <div className='flex flex-col h-full'>
            <div className='text-4xl font-bold mb-4 text-center'>Adrenalina na Maksymalnych Obrotach</div>
            <div className='text-lg mt-4 text-center md:text-left'>
        ...
        <div className='w-full flex flex-col md:flex-row gap-12 my-8 items-center'>
          <div className='flex flex-col h-full'>
            <div className='text-4xl font-bold text-center md:text-left mb-4'>Przygoda dla Całej Rodziny</div>
            <div className='text-lg mt-4 text-center md:text-left'>
          ...
          <Image src={familyOffroad} alt='mountains-offroad' className='order-first md:order-last md:w-1/3 rounded-3xl' />
        </div>
        <div className='w-full flex flex-col gap-12 my-8 mt-16 items-center'>
          <Image src={communityOffroad} alt='mountains-offroad' className='md:w-3/4 rounded-3xl' />
          <div className='flex flex-col h-full'>
            <div className='text-4xl font-bold mb-4 text-center'>Społeczność Offroad</div>
