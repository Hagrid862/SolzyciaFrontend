      ...
      <div className="w-full max-w-screen flex-col items-center flex">
        ...
        <div className="max-w-[1200px] w-full flex flex-col justify-center items-center my-12 px-4">
          ...
          <div className="flex flex-col md:flex-row gap-8 mx-8">
            ...
            >
              <Card
                className="relative items-center max-w-[250px] w-full"
          ...
          <div className="flex flex-col md:flex-row mt-12 w-full items-center">
            <Image
              src={logo}
              alt="logo"
              className="md:w-1/4 lg:w-1/3 m-12 aspect-square"
            />
            <div className="text-justify">
              Jesteśmy dynamiczną firmą specjalizującą się w organizacji gier
              zespołowych, kursów survivalowych, off-roadu i bushcraftu. Nasza
              misja to inspirowanie ludzi do odkrywania radości i korzyści
              płynących z aktywności na świeżym powietrzu. Wierzymy, że przygody
              na łonie natury wzmacniają więzi, rozwijają umiejętności
              przetrwania i promują szacunek do środowiska. Zaczęliśmy jako
              grupa przyjaciół pasjonujących się outdoorowymi wyzwaniami, a
              teraz z dumą dzielimy się naszym doświadczeniem i wiedzą z innymi.
              Nasze wartości to współpraca, autentyczność i zrównoważony rozwój.
              Zapewniamy niezapomniane przeżycia, które budują społeczność
              opartą na zaufaniu i wzajemnym wsparciu.
            </div>
          </div>
          <div className="flex flex-col md:flex-row mt-12 items-center justify-center mb-16">
            <Image
              src={jeepOffroadImage}
              alt="off-road-jeep"
              className="order-first md:order-last md:w-1/3 lg:w-1/3 m-12"
            />
            <div>
              <div className="text-3xl font-semibold text-center md:text-right">
                Off-road
              </div>
              <div className="text-justify">
                Od wielu lat bierzemy udział w rajdach i wyprawach. W końcu
                zaczęliśmy sami takie imprezy organizować. Od samego początku
                dzieliliśmy naszą pasję z rodziną i znajomymi - towarzyszyli nam
                wspaniali ludzie podczas imprez, rajdów czy na dalekich
                wyprawach. Od jakiegoś czasu wprowadzamy w świat offroad&apos;u
                również osoby spoza kręgu znajomych - zapraszamy do wspólnej
                zabawy &quot;w błocie&quot;!
              </div>
          ...
          <div className="flex md:flex-row flex-col gap-4 w-full justify-center items-center">
            <Image
              src={knifepng}
              alt="knife transparent background"
              className="md:w-1/4 w-3/4 -rotate-90 md:rotate-0 md:mb-0 -mb-24"
            />
            <div className="h-full flex flex-col items-center justify-center">
              <div className="text-3xl font-semibold text-center md:text-left w-full">
                Survival
              </div>
              <div className="text-justify">
                Od lat młodzieńczych dużo czasu spędzaliśmy poza cywilizacją
                radząc sobie z minimalnym wyposażeniem za to nadrabiając wiedzą
                i doświadczeniem. Najbardziej komfortowym &quot;wyjściem do
                lasu&quot; była corocznie zdobywana sprawność &quot;Trzy
                pióra&quot; - można powiedzieć że to wyjście do lasu miało
                &quot;gdzieś tam&quot; wsparcie logistyczne&quot; chyba że się
                zgubiliśmy w lesie. Nasze umiejętności nabyte podczas kilku
                dekad pozwalają nam na zapewnienie kursantom bezpieczeństwa ale
                również niezwykłych przeżeżyć!
              </div>
              <div className="flex flex-row justify-center mt-4">
                <Button
                  className="mt-4"
